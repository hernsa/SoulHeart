...
const VALID_TRANSITIONS := {
	...
	Phase.PLAYER_TURN: [Phase.FIGHT, Phase.ACT, Phase.ITEM, Phase.MERCY, Phase.ENEMY_TURN, Phase.SPARED],
	...
	Phase.ENEMY_TURN: [Phase.PLAYER_TURN, Phase.LOSE, Phase.WIN, Phase.SPARED],
	Phase.WIN: [],
	Phase.LOSE: [],
	Phase.SPARED: [],
}
