...
const SECTIONS: Array = [
    {
        ...
        "objects": [
            {"type": "spawn",   "cell": Vector2i(8, 11), "data": {}},
            {"type": "landmark", "cell": Vector2i(8, 3), "data": {"label": "the Lone Pine"}},
            {"type": "interact", "cell": Vector2i(7, 3), "data": {"kind": "lone_pine"}},
        ],
        "flavor": [
            {"kind": "tall_grass", "cell": Vector2i(3, 7)},
            {"kind": "tall_grass", "cell": Vector2i(10, 7)},
            {"kind": "tall_grass", "cell": Vector2i(2, 12)},
            {"kind": "tall_grass", "cell": Vector2i(11, 12)},
            {"kind": "golden_flower", "cell": Vector2i(2, 9)},
            {"kind": "golden_flower", "cell": Vector2i(9, 9)},
            {"kind": "golden_flower", "cell": Vector2i(3, 13)},
            {"kind": "golden_flower", "cell": Vector2i(10, 13)},
