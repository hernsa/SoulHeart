...
func test_overworld_assets_exist() -> void:
	for f in ["frisk.png", "frisk_walk.gif", "save_point.gif", "rock.png",
...
func test_frisk_dimensions() -> void:
	...
	if img == null:
		return
	TestHelper.eq(img.get_width(), 38, "frisk width 38 (2x2 grid of 19x29)")
	TestHelper.eq(img.get_height(), 58, "frisk height 58")
