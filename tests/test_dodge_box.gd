...
func test_heart_starts_at_center_and_visibility() -> void:
	var box := _make_box()
	TestHelper.eq(box.heart.position, Vector2(317, 317), "heart at box center")
...
func test_heart_moves_and_clamps_to_box() -> void:
	...
	box._process(10.0)
	TestHelper.eq(box.heart.position.x, 585.0, "clamps at right edge")
	Input.action_release("move_right")
	Input.action_press("move_left")
	box._process(10.0)
	TestHelper.eq(box.heart.position.x, 36.0, "clamps at left edge")
	Input.action_release("move_left")
	Input.action_press("move_up")
	box._process(10.0)
	TestHelper.eq(box.heart.position.y, 254.0, "clamps at top edge")
	Input.action_release("move_up")
	Input.action_press("move_down")
	box._process(10.0)
	TestHelper.eq(box.heart.position.y, 368.0, "clamps at bottom edge")
	Input.action_release("move_down")
	box._process(1.0)
	TestHelper.eq(box.heart.position, Vector2(36, 368), "stays put with no input")
	box.free()
